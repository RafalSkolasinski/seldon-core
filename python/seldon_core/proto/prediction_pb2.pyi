...
class SeldonModelMetadata(google___protobuf___message___Message):
    ...
    class TensorMetadata(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> SeldonModelMetadata.TensorMetadata: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SeldonModelMetadata.TensorMetadata: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    ...
    class SeldonMessageMeta(google___protobuf___message___Message):
        DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
        datatype = ... # type: typing___Text
        shape = ... # type: google___protobuf___internal___containers___RepeatedScalarFieldContainer[builtin___int]
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> SeldonModelMetadata.SeldonMessageMeta: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SeldonModelMetadata.SeldonMessageMeta: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def HasField(self, field_name: typing_extensions___Literal[u"schema",b"schema"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"datatype",b"datatype",u"schema",b"schema",u"shape",b"shape"]) -> None: ...
    global___SeldonMessageMeta = SeldonMessageMeta
    ...
    @property
    def input(self) -> global___SeldonModelMetadata.SeldonMessageMeta: ...

    @property
    def output(self) -> global___SeldonModelMetadata.SeldonMessageMeta: ...

    @property
    def inputs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[global___SeldonModelMetadata.TensorMetadata]: ...

    @property
    def outputs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[global___SeldonModelMetadata.TensorMetadata]: ...
    ...
    def __init__(self,
        *,
        ...
        input : typing___Optional[global___SeldonModelMetadata.SeldonMessageMeta] = None,
        output : typing___Optional[global___SeldonModelMetadata.SeldonMessageMeta] = None,
        inputs : typing___Optional[typing___Iterable[global___SeldonModelMetadata.TensorMetadata]] = None,
        outputs : typing___Optional[typing___Iterable[global___SeldonModelMetadata.TensorMetadata]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
    ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"input",b"input",u"output",b"output"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"apiVersion",b"apiVersion",u"input",b"input",u"inputs",b"inputs",u"name",b"name",u"output",b"output",u"outputs",b"outputs",u"platform",b"platform",u"versions",b"versions"]) -> None: ...
